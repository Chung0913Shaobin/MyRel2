...
def ask_deepseek(prompt):
    ...
    try:
        response = requests.post(
            ...
            headers=HEADERS,
            json={
                "model": "deepseek-chat",  # 你可以測試其他 DeepSeek 模型
        ...
        logging.error(f"DeepSeek API 請求失敗：{e}")
        return "AI 產生回應時發生錯誤"
...
def upload_file():
    ...
    {resume_text}
    """
    categorized_skills = ask_deepseek(skill_prompt)
    ...
    suggestions = ask_deepseek(suggestion_prompt)
   ...
   - 21-25：個人形象完整，極具競爭力
    ...
    {resume_text}
    """
    evaluation = ask_deepseek(evaluation_prompt)
